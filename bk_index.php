...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="css/permit.css?r=<?php /*echo $rand*/ ?>"/>
    
	<link rel="stylesheet" type="text/css" href="css/food.css?r=<?php echo $rand ?>"/>
	<link rel="stylesheet" type="text/css" href="css/food_tree.css?r=<?php echo $rand ?>"/>
    <link rel="stylesheet" type="text/css" href="css/food_edit.css?r=<?php echo $rand ?>"/>
	<link rel="stylesheet" type="text/css" href="css/food_list_report.css?r=<?php echo $rand ?>"/>
	<link rel="stylesheet" type="text/css" href="css/food_list_ditail.css?r=<?php echo $rand ?>"/>
    ...
    <script type="text/javascript" src="js/permit.js?r=3<?php /*echo $rand*/ ?>"></script>
    
	<script type="text/javascript" src="js/food_tree.js?r=<?php echo $rand ?>"></script>
    <script type="text/javascript" src="js/food_edit.js?r=<?php echo $rand ?>"></script>
	<script type="text/javascript" src="js/food_hafte_user.js?r=<?php echo $rand ?>"></script>
    <script type="text/javascript" src="js/food_hafte_edit.js?r=<?php echo $rand ?>"></script>
	<script type="text/javascript" src="js/food_list_report.js?r=<?php echo $rand ?>"></script>
	<script type="text/javascript" src="js/food_list_ready.js?r=<?php echo $rand ?>"></script>
	
	
    <script type="text/javascript" src="js/optplan.js?r=<?php /*echo $rand*/ ?>"></script>    
    <script type="text/javascript" src="js/desktop.js?r=<?php echo $rand ?>"></script>
