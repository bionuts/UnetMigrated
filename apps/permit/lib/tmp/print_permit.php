<?php
		...
		@$export_date_tmp= explode(" ",$activity_date_result['permit_main_tarikhsaat_sodoor_byocc']);
		@$export_date=explode("-",$export_date_tmp[0]);
		//echo($darkhast_date_tmp[1]);
		@$export_time = explode(":",$export_date_tmp[1]);
		@$export_date = jdate('l , j F Y',strtotime($export_date));//(gregorian_to_jalali( $export_date[0] , $export_date[1] , $export_date[2] , "/" ));//."<br />". $export_time[0].":".$export_time[1];
?>
<!DOCTYPE html>
<html>
	<head>
	...
	<body style="padding:0;margin:0;">
		<div id="print_main" class="box_sized print" style="padding:0;margin:0;position:relative;">
			<div style="position:absolute;left:60px;top:40px;z-index:101 !important;"><img src="img/done.png" style="width:120px;height:120px;-ms-transform: rotate(-36deg);-webkit-transform: rotate(-36deg);transform: rotate(-36deg);"/></div>
			<div id="print_header" class="box_sized print" style="height:130px;position:relative;">
				<div id="print_mojavez_num" style="text-align:right;direction:rtl;position:absolute;top:15px;right:15px;width:200px;">
					شماره مجوز : <?php echo @$mojavez_id;?><br/><br/>
					تاریخ فعالیت : <br /> <?php echo @str_replace($english_digits, $persian_digits,$export_date);?>
				</div>	
			...
			<div id="print_form_info" class="box_sized print">
				<table border="0" style="width:100%;" class="print">
					...
					<tr>
						<td style="font-weight:bold;background-color:#f0f0f0;/* background:url('img/bk.jpg') top right;*/">نام پیمانکار : <span style="font-weight:normal;"><?php 
			...
			<div id="print_accept_text" class="print" style="display:;" >
				...
				<p class="print_reset" style="font:15px tahoma;font-weight:bold;color:red;"><?php echo @str_replace($english_digits, $persian_digits,$data_result['permit_main_dalilradocc']);?></p>
			</div>
