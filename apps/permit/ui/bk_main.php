...
$util = new UtilClass();
if(!$util->haveAcces('permit',$_SESSION["userid"]))exit;
    ...
    <div class="windowpanel_body box_sized" id="permit_body_panel"
        ...
        <div id="user_more_info_main" class="box_sized radius5 user_more_info"
            ...
            <div id="user_more_info_form_info" class="box_sized user_more_info" style="background-color:white;">
                ...
                <div id="user_more_info_form_info_internal" class="box_sized user_more_info">
                    ...
                    <p>نام خانوادگی : زاده مینایی</p>

                    <p>واحد نظارت : عملیات</p>
        ...
        <div id="permit_tabs" style="width:100%;height:100%;" class="box_sized">
            <ul>
                ...
                $canreq = false;
                if (($hour < $deadtimereq) && $roleid != 1) $canreq = true;
				//echo $hour;
                if ($canreq) {
                    ?>
                    <li><a href="#tabs-4">درخواست مجوز</a></li>
                <?php
                }
                ?>
            </ul>
            <div id="tabs-1" style="padding:0px;padding-top:5px;min-width:800px;height: 94%;width: 100%;">
                <div style="height: 100%;width: 100%;" id="permit_tab1_content">
                    <table class="permit_tbl" id="permit_tbl_today_permits"
                        ...
                        <tr class="permit_row_green" style="visibility:collapse;"><td><img title="پرینت مجوز" style="width:26px;" src="img/p3.png" class="permit_img_show_details show_printable_green" permit_id="11641"></td><td style="text-align:center;">۱۱۶۴۱</td><td style="text-align:center;position:relative;z-index:999;padding:0px;padding-bottom:1px;"><img title="مشاهده توضیحات مرکز فرمان" style="width:35px;height:35px;margin:0px auto;" src="img/warn.png" class="permit_img_show_occ_cmnt btnpointer" vhid="true"><div style="position:absolute;top:5px;display:none;" class="permit_occ_hidden"><div style="float:right;position:absolute;top:10px;right:-9px;"><div class="rightarrow"></div></div><div class="cmnt_occ radius5" style="float:left;width:400px;">	<div style="overflow:auto;" class="cmnt_occ_header box_sized"><div style="float:right;margin-left:5px;margin-right:3px;"><img style="width:20px;height:20px;" src="img/warn.png" class="permit_img_show_details"></div><div style="position:relative;display:inline-block;width:80%;">شرح شرايط انجام كار</div></div><div class="cmnt_occ_body box_sized">"این مجوز جهت تردد درزین 961 در خط B و در محدوده خط 4 پایانه تا ایستگاه احسان و کراس اور احسان از ساعت 00:01 تا ساعت 7:00 صادر شده است. انجام هر گونه حرکت و مانور در مسیر رفت و برگشت و شانت از سوزنها، منوط به استعلام آزادی خط از طریق بیسیم از بخش کنترل ترافیک مرکز کنترل و فرمان میباشد.<br>شروع و پایان فعالیت با مرکز فرمان هماهنگ نمایید و استعلام قطع برق شبکه بالاسری گرفته شود.<br>رعایت کلیه نکات ایمنی و حضور ناظر الزامی می باشد.<br>دستگاه نظارت موظف است که قبل از اقدام به تایید مجوز و همچنین در زمان شروع عملیات، هماهنگی های لازم را با بخش مانور عملیات انجام دهد."</div></div></div></td><td style="text-align:center;position:relative;z-index:998;padding:0px;padding-bottom:1px;"><img title="مشاهده شرح عملیات" src="img/mail.png" style="width:28px;height:28px;" class="permit_img_show_info_req_cmnt btnpointer" vhid="true"><div style="position:absolute;top:0px;display:none;" class="permit_info_req_hidden"><div style="float:right;position:absolute;top:10px;right:-9px;"><div class="rightarrowblue"></div></div><div class="cmnt_desc_req radius5 box_sized" style="float:left;width:400px;"><div style="overflow:auto;" class="cmnt_desc_req_header box_sized"><div style="display:inline-block;margin-left:5px;margin-right:3px;"><img style="width:20px;height:20px;" src="img/mail.png" class="permit_img_show_details"></div><div style="position:relative;top:-6px;display:inline-block;width:80%;">شرح عملیات</div></div><div class="cmnt_desc_req_body box_sized">انجام PM ، خط 4 توقفگاه و محدوده بین توقفگاه و ایستگاه احسان خط B و کراس اورهای مسیر از ساعت 00:01 الی 7:30</div></div></div></td><td style="text-align:center;">برق</td><td style="text-align:center;direction:ltr;">2254</td><td style="text-align:center;">شرکت  سامان ساخت برنا تارا</td><td style="text-align:center;">00:01 بامداد تا شروع بهره برداری</td><td style="text-align:center;">حریم ریلی پایانه</td><td style="text-align:center;position:relative;z-index:999;"><img title="مشاهده محل کار فعالیت" style="margin:0px;width:30px;height:30px;position: relative;top:3px;" src="img/places6.png" class="permit_img_show_nazer_cmnt btnpointer" vhid="true"><div style="position:absolute;top:5px;left:60px;display:none;" class="permit_nazer_hidden"><div style="float:left;position:absolute;top:10px;left:-9px;"><div class="leftarrow"></div></div><div class="cmnt_nazer radius5 box_sized" style="float:right;width:400px;"><div style="overflow:auto;" class="cmnt_nazer_header box_sized"><div style="float:right;margin-left:5px;margin-right:3px;"><img style="width:20px;height:20px;" src="img/places6.png" class="permit_img_show_details"></div><div style="position:relative;display:inline-block;width:80%;">لیست محل کار</div></div><div class="cmnt_nazer_body box_sized">پایانه احسان</div></div></div></td><td style="text-align:center;">وسیله نقلیه ریلی کمکی</td><td style="text-align:center;">دارد</td><td><img vhid="true" class="permit_img_trpermit_req btnpointer" style="width:34px;height:34px;" src="img/trp6.png" title="تائید یا رد درخواست" permitid="11641"></td></tr>
                        <?php
            ...
            <div id="tabs-2"
                ...
                <div id="permit_tab2_content" style="height: 100%;width: 100%;">
                    <table class="permit_tbl" id="permit_tbl_today_permits_today_permitions"
                        ...
                        <tr class="permit_row_green" style="visibility: collapse;"><td><img title="پرینت مجوز" style="width:26px;" src="img/p3.png" class="permit_img_show_details show_printable_green" permit_id="11583"></td><td style="text-align:center;">۱۱۵۸۳</td><td style="text-align:center;position:relative;z-index:999;padding:0px;padding-bottom:1px;"><img title="مشاهده توضیحات مرکز فرمان" style="width:35px;height:35px;margin:0px auto;" src="img/warn.png" class="permit_img_show_occ_cmnt btnpointer" vhid="true"><div style="position:absolute;top:5px;display:none;" class="permit_occ_hidden"><div style="float:right;position:absolute;top:10px;right:-9px;"><div class="rightarrow"></div></div><div class="cmnt_occ radius5" style="float:left;width:400px;">	<div style="overflow:auto;" class="cmnt_occ_header box_sized"><div style="float:right;margin-left:5px;margin-right:3px;"><img style="width:20px;height:20px;" src="img/warn.png" class="permit_img_show_details"></div><div style="position:relative;display:inline-block;width:80%;">شرح شرايط انجام كار</div></div><div class="cmnt_occ_body box_sized">"ورود به حریم ریلی اکیدا ممنوع میباشد.<br>این مجوز جهت تردد در ایستگاه صادر شده است. انجام هر گونه فعالیت در اتاقهای فنی منوط به حضور ناظر و هماهنگی با دستگاه نظارت مربوطه میباشد.<br>هر گونه فعالیت منجر به قطع برق تجهیزات یا منتج به ناپایداری و از دسترس خارج شدن و قطع نمایش اطلاعات ترافیکی سیستم های کنترل ترافیک که باعث اختلال در مسیر سازی و مانیتورینگ وسایل نقلیه ریلی گردد ممنوع میباشد."</div></div></div></td><td style="text-align:center;position:relative;z-index:998;padding:0px;padding-bottom:1px;"><img title="مشاهده شرح عملیات" src="img/mail.png" style="width:28px;height:28px;" class="permit_img_show_info_req_cmnt btnpointer" vhid="true"><div style="position:absolute;top:0px;display:none;" class="permit_info_req_hidden"><div style="float:right;position:absolute;top:10px;right:-9px;"><div class="rightarrowblue"></div></div><div class="cmnt_desc_req radius5 box_sized" style="float:left;width:400px;"><div style="overflow:auto;" class="cmnt_desc_req_header box_sized"><div style="display:inline-block;margin-left:5px;margin-right:3px;"><img style="width:20px;height:20px;" src="img/mail.png" class="permit_img_show_details"></div><div style="position:relative;top:-6px;display:inline-block;width:80%;">شرح عملیات</div></div><div class="cmnt_desc_req_body box_sized">نگهداری و تعمیرات سیستم های مخابراتی و گیت های AFC</div></div></div></td><td style="text-align:center;">سیگنالینگ ، کنترل و مخابرات</td><td style="text-align:center;direction:ltr;">0938 650 9296</td><td style="text-align:center;">شرکت آریا همراه سامانه</td><td style="text-align:center;">اتمام بهره برداری تا 23:59</td><td style="text-align:center;">اماکن ایستگاهی</td><td style="text-align:center;position:relative;z-index:999;"><img title="مشاهده محل کار فعالیت" style="margin:0px;width:30px;height:30px;position: relative;top:3px;" src="img/places6.png" class="permit_img_show_nazer_cmnt btnpointer" vhid="true"><div style="position:absolute;top:5px;left:60px;display:none;" class="permit_nazer_hidden"><div style="float:left;position:absolute;top:10px;left:-9px;"><div class="leftarrow"></div></div><div class="cmnt_nazer radius5 box_sized" style="float:right;width:400px;"><div style="overflow:auto;" class="cmnt_nazer_header box_sized"><div style="float:right;margin-left:5px;margin-right:3px;"><img style="width:20px;height:20px;" src="img/places6.png" class="permit_img_show_details"></div><div style="position:relative;display:inline-block;width:80%;">لیست محل کار</div></div><div class="cmnt_nazer_body box_sized">ایستگاه احسان - ایستگاه شریعتی - ایستگاه میرزا شیرازی - ایستگاه شاهد - ایستگاه قصردشت - ایستگاه مطهری - ایستگاه آوینی - ایستگاه نمازی - پایانه احسان</div></div></div></td><td style="text-align:center;">گروه پیاده</td><td style="text-align:center;">ندارد</td><td style="direction: ltr;text-align: center;">۱۳۹۳/۱۱/۲۰</td></tr>
                        <?php
            ...
            <div id="tabs-3" style="padding:0px;padding-top:5px;height: 94%;width: 100%;">
                ...
                <div id="permit_tab3_content" style="height: 100%;width: 100%;">
                    <table class="permit_tbl" id="permit_tbl_bayegani_permits" style="width: 100%;height: 100%;">
                        <thead id="permit_tabl_thead" style="display:block;"><!---->
                        <tr class="footer_row">
                            <td colspan="<?php if ($roleid == 3 || $roleid == 4) echo '13'; else echo '14'; ?>"
                                style="padding:0px;"
                                class="box_sized">
                        ...
                        <tr class="permit_row_yellow" style="visibility: collapse;"><td><img title="جزئیات" src="img/info2.png" style="width:24px;" class="permit_img_show_details permit_img_show_details_noedit_info" permit_id="11701"></td><td style="text-align:center;">۱۱۷۰۱</td><td style="text-align:center;position:relative;z-index:999;padding:0px;padding-bottom:1px;">مجوز در حال بررسی می باشد</td><td style="text-align:center;position:relative;z-index:998;padding:0px;padding-bottom:1px;"><img title="مشاهده شرح عملیات" src="img/mail.png" style="width:28px;height:28px;" class="permit_img_show_info_req_cmnt btnpointer" vhid="true"><div style="position:absolute;top:0px;display:none;" class="permit_info_req_hidden"><div style="float:right;position:absolute;top:10px;right:-9px;"><div class="rightarrowblue"></div></div><div class="cmnt_desc_req radius5 box_sized" style="float:left;width:400px;"><div style="overflow:auto;" class="cmnt_desc_req_header box_sized"><div style="display:inline-block;margin-left:5px;margin-right:3px;"><img style="width:20px;height:20px;" src="img/mail.png" class="permit_img_show_details"></div><div style="position:relative;top:-6px;display:inline-block;width:80%;">شرح عملیات</div></div><div class="cmnt_desc_req_body box_sized">فیکس و تنظیم نمودن cw خط سه توقفگاه . محدوده : خط ۳ پایانه و محدوده ی بین توقفگاه و ایستگاه احسان هر دو خط درزین های مورد نیاز ۹۶۰ و ۹۶1 (بسته به شرایط از یکی از درزین ها استفاده خواهد شد).</div></div></div></td><td style="text-align:center;">برق</td><td style="text-align:center;direction:ltr;">2254</td><td style="text-align:center;">شرکت  سامان ساخت برنا تارا</td><td style="text-align:center;">00:01 بامداد تا شروع بهره برداری</td><td style="text-align:center;">حریم ریلی پایانه</td><td style="text-align:center;position:relative;z-index:999;"><img title="مشاهده محل کار فعالیت" style="margin:0px;width:30px;height:30px;position: relative;top:3px;" src="img/places6.png" class="permit_img_show_nazer_cmnt btnpointer" vhid="true"><div style="position:absolute;top:5px;left:60px;display:none;" class="permit_nazer_hidden"><div style="float:left;position:absolute;top:10px;left:-9px;"><div class="leftarrow"></div></div><div class="cmnt_nazer radius5 box_sized" style="float:right;width:400px;"><div style="overflow:auto;" class="cmnt_nazer_header box_sized"><div style="float:right;margin-left:5px;margin-right:3px;"><img style="width:20px;height:20px;" src="img/places6.png" class="permit_img_show_details"></div><div style="position:relative;display:inline-block;width:80%;">لیست محل کار</div></div><div class="cmnt_nazer_body box_sized">پایانه احسان</div></div></div></td><td style="text-align:center;">وسیله نقلیه ریلی کمکی</td><td style="text-align:center;">دارد</td><td style="direction: ltr;text-align: center;">-</td></tr>
                        <?php
                            ...
                            <div style="margin-top:5px;margin-bottom:5px;outline:0px solid red;">
                                <div style="display:inline-block;direction:rtl;text-align:right;vertical-align: top;">
                                    <fieldset class="permit_fieldset_style radius5"
                                              style="text-align:right;height:220px;width:506px;">
                                ...
                                <div style="display:inline-block;direction:rtl;text-align:right;vertical-align: top;">
                                    <fieldset class="permit_fieldset_style radius5" style="height:120px;width:506px;">
                                        <legend align="" class="radius3">قطع برق</legend>
                            ...
                            <div style="margin-top:5px;outline:0px solid red;">
                                <div style="display:inline-block;direction:rtl;text-align:right;vertical-align: top;">
                                    <fieldset class="permit_fieldset_style radius5" id="fieldset_nezarat"
                                              style="height:300px;width:506px;">
                                        <legend align="" class="radius3">نظارت</legend>
                                        <div>
                                            <table style="width:100%;padding:0px;margin:0px;">
                                                ...
                                                <tr>
                                                    <td colspan="2">
                                                        <div style="margin-bottom:3px;">ناظر گروه : <span
                                                ...
                                                <tr>
                                                    <td>
                                                        <div style="margin-bottom:3px;">لیست نفرات : <span
                                                                id="permit_selected_num_of_worker" style="color:blue;">0 انتخاب</span>
                                                        </div>
                                                        <div
                                    ...
                                    <fieldset class="permit_fieldset_style radius5" style="width:506px;height:;">
                                        ...
                                        <div>
                                            <table style="width:100%;padding:0px;margin:0px;">
                                                ...
                                                <tr>
                                                    <td>
                                                        <div style="margin-bottom:7px;position:relative;">محل کار:  <button id="btn_sall" title="MHM Bugfixes" style="position:absolute;right:60px;top:-1px;">All</button></div>
                                                        <div>
                                                            ...
                                                            <div id="permit_cmbx_working_place_div"
                                                                 style="width:90%;padding:5px;background-color:#dee0ff;position:relative;"
                                                                 class="box_sized">
                                    ...
                                    <div>
                                        ...
                                        <div style="text-align:center;">
                                            ...
                                            <input id="permit_btn_req_permit" type="button"
                                                   class="permit_btn_style radius5"
